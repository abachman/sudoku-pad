...
class Button {
  ...
  private draw() {
    ...
    this.border = this.svg.rect(bbox.width, bbox.height)
      .stroke("none")
      .fill("none")
      .center(cx, cy);
...
Button.DOWNLOAD =
  `m49.26 62a1.06 1.06 0 001.48 0l12.9-13a1 1 0 000-1.47l-2.32-2.33a1.06 1.06 0 00-1.48 0l-7.15 7.2v-23.86a1 1 0 00-1-1h-3.3a1 1 0 00-1 1v23.86l-7.15-7.16a1.06 1.06 0 00-1.48 0l-2.32 2.33a1 1 0 000 1.47zm-13.26 5h28v6h-28v-6z`;

Button.PLUS = 
  `m488 1106-5 0 0 5c0 .55-.447 1-1 1-.553 0-1-.45-1-1l0-5-5 0c-.553 0-1-.45-1-1 0-.55.447-1 1-1l5 0 0-5c0-.55.447-1 1-1 .553 0 1 .45 1 1l0 5 5 0c.553 0 1 .45 1 1 0 .55-.447 1-1 1l0 0zm-6-17c-8.837 0-16 7.16-16 16 0 8.84 7.163 16 16 16 8.837 0 16-7.16 16-16 0-8.84-7.163-16-16-16l0 0z`
